    ...
    render() {
      ...
      return (
        ...
        <TouchableOpacity
              ...
              <Text style={{fontSize: 40, backgroundColor: '#95adbe', textAlign: 'center',
                borderWidth: 1 }}> Graphic Design </Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity
              ...
              <Text style={{fontSize: 40, backgroundColor: '#e1f2fb', textAlign: 'center',
                borderWidth: 1, marginLeft: 80, marginRight: 80 }}> Photography </Text>
        </TouchableOpacity>
