      ...
      return (
        ...
        <TouchableOpacity
              ...
              <View style={{
                ...
                alignSelf: 'center' }}>ABCDEFGHIJKLMNOPQRSTUVWXYZ
                </Text>
              </View>
        ...
        <TouchableOpacity
              ...
              <Text style={{fontSize: 22, backgroundColor: '#465881', textAlign: 'center',
                borderWidth: 1, marginLeft: 110, marginRight: 110 }}> Searocks Regular </Text>
              <View style={{
                flex: 1, 
                flexDirection: 'row',
                aspectRatio: 1,
                ...
                <Text style={{fontSize: 30, textAlign: 'center', 
                alignSelf: 'center', marginLeft: 11, marginRight: 11 }}>ABCDEFGHIJKLMNOPQRSTUVWXYZ
                </Text>
              </View>
